  ...
  return (
    <main className="w-screen bg-[#ccc] dark:bg-[#555] pb-4">
      ...
      >
        <div
          id="cartItem"
          className="w-[95%] min-h-[85vh] p-4 relative z-[15] mx-[2.5%] lg:mt-[7.8%] xsm:mt-[20%] sm:mt-[20%] md:mt-[12.5%] bg-white dark:bg-zinc-900 dark:text-white shadow-lg shadow-black rounded-3xl overflow-hidden flex flex-col items-center box-sizing justify-items-center gap-5 py-5"
        >
