...
const Checkout = () => {
  ...
  return (
    ...
    <main className="w-screen bg-[#0b0b0b]">
      <div
        id="landingPage"
        className="w-[100vw] bg-[#ccc] min-h-[100vh] z-10 flex flex-col items-center justify-center"
      >
        <div
          id="data"
          className="w-[95%] md:min-h-[85vh] p-4 relative z-[15] mx-[2.5%] md:mt-[7.5%] xsm:mt-[20%] sm:mt-[14%] bg-white shadow-lg shadow-black rounded-3xl overflow-hidden  flex md:flex-row xsm:flex-col items-center box-sizing justify-items-center gap-5"
        >
          <div
            id="left"
          ...
          >
            ...
            <form
              className="md:w-[80%] md:h-[90%] xsm:h-full justify-self-center items-center flex flex-col shadow-lg shadow-black py-2"
              action=""
              onSubmit={getDetails}
            >
              {/* {finalShipDet.length > 0 && ( */}
                <select
                  className="bg-[#adacac] w-[70%] py-4 px-3 mt-1 rounded-2xl text-[0.9em]"
                  name="address"
              ...
              <input
                onChange={getfName}
                value={firstName}
                className="py-3 px-2 rounded-2xl mt-4 w-[65%] shadow-sm shadow-black outline-none"
                type="text"
          ...
          >
            ...
            <div className="md:w-[80%] md:h-[90%] xsm:w-[90%] xsm:min-h-[50vh] justify-self-center items-center flex flex-col shadow-lg shadow-black py-2">
